...
const Banner = () => {
  return (
    <div className="relative flex flex-col sm:flex-row items-center max-sm:py-5 m-0 overflow-hidden">
      ...
      {/* Content Section */}
      <div className="relative h-full sm:w-1/2 z-10 flex flex-col sm:items-start justify-center gap-3 sm:gap-10 sm:p-4 sm:ml-5 md:ml-10 lg:ml-16">
