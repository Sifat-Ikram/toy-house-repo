...
const UserProfile = () => {
  ...
  const { name, username, email, phone_number, addresses } = userData || {};

  return (
    <div className="min-h-screen bg-white dark:bg-white dark:text-black max-sm:px-[10px] max-md:px-[5px] flex flex-col items-center space-y-6 md:space-y-10">
      <h1 className="text-lg sm:text-xl md:text-2xl lg:text-4xl font-poppins font-semibold text-center pt-6 md:pt-10">
        User Profile
      </h1>
      <div className="w-full sm:w-11/12 md:w-4/5 rounded-[10px] py-2 sm:py-[10px] md:py-[16px] lg:py-[26px] mx-auto bg-[#F5F5F5] dark:bg-[#F5F5F5]">
        <div className="w-11/12 md:w-5/6 mx-auto flex max-sm:flex-wrap items-center justify-between bg-[#F5F5F5] dark:bg-[#F5F5F5]">
          <div className="w-1/3 flex flex-col items-start">
            <h1 className="text-[10px] sm:text-xs md:text-sm lg:text-lg font-roboto font-normal text-[#757575] dark:text-[#757575]">
              Customer Name :
            </h1>
            <h1 className="text-sm md:text-xl lg:text-[28px] font-poppins font-normal text-[#000000] dark:text-[#000000]">
              {name || username}
            </h1>
          </div>
          <div className="flex-1 flex justify-between items-center">
            <div className="w-1/2 flex flex-col items-start">
              <h1 className="text-[10px] sm:text-xs md:text-sm lg:text-lg font-roboto font-normal text-[#757575] dark:text-[#757575]">
                Customer Email :{" "}
                <span className="text-[#000000] dark:text-[#000000]">
                  {email}
                </span>
              </h1>
              <h1 className="text-[10px] sm:text-xs md:text-sm lg:text-lg font-roboto font-normal text-[#757575] dark:text-[#757575]">
            ...
            <div className="w-1/2 ml-[14px] sm:ml-5 md:ml-6 lg:ml-10 flex flex-col items-start">
              <h1 className="text-xs sm:text-sm md:text-base lg:text-lg font-roboto font-normal text-[#757575] dark:text-[#757575]">
                Address :{" "}
                <span className="text-[10px] sm:text-xs lg:text-base text-[#000000] dark:text-[#000000]">
                  {addresses}
                </span>
              </h1>
            </div>
      ...
      <div className="w-full sm:w-11/12 md:w-4/5 mx-auto bg-white dark:bg-white space-y-2 sm:space-y-[14px] py-[6px] sm:py-2 md:py-[10px] px-[6px] sm:px-2 md:px-[10px] rounded-[14px] flex flex-col border-[1px] border-solid">
        <div className="w-full bg-[#F5F5F5] dark:bg-[#F5F5F5] py-1 sm:py-3 md:py-[15px] px-2 sm:px-3 md:px-[27px] rounded-[14px]">
          <h1 className="font-poppins font-normal sm:font-semibold text-sm md:text-xl">My Orders</h1>
        </div>
              ...
              >
                <div className="flex flex-row items-center justify-between space-y-2 md:space-y-0">
                  ...
                  <div className="flex flex-col sm:flex-row items-center max-sm:space-y-1 sm:gap-2 md:gap-3 lg:gap-5">
                    ...
                    <div>
                      <ExportDetails id={order?.order_id} />
                    </div>
                  </div>
                </div>
